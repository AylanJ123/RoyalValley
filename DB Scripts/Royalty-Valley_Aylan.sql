USE [master]
GO
/****** Object:  Database [RoyaltyValley-Aylan_Sebas]    Script Date: 2/22/2023 11:00:02 AM ******/
CREATE DATABASE [RoyaltyValley-Aylan_Sebas]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'RoyaltyValley-Aylan_Sebas', FILENAME = N'D:\DB\RoyaltyValley-Aylan_Sebas.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'RoyaltyValley-Aylan_Sebas_log', FILENAME = N'D:\DB\RoyaltyValley-Aylan_Sebas_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
GO
/****** Object:  Table [dbo].[Cobro]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Edificio]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[EdificioPublico]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Incidencia]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Noticias]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PlanCobro]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Reserva]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Residencia]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Rubro]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RubroPlan]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Usuario]    Script Date: 2/22/2023 11:00:02 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Usuario__2A586E0BA9709953]    Script Date: 2/22/2023 11:00:03 AM ******/
ALTER TABLE [dbo].[Usuario] ADD UNIQUE NONCLUSTERED 
(
	[correo] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Cobro]  WITH CHECK ADD  CONSTRAINT [FK_Cobro_PlanCobro1] FOREIGN KEY([planCobro])
REFERENCES [dbo].[PlanCobro] ([ID])
GO
ALTER TABLE [dbo].[Cobro] CHECK CONSTRAINT [FK_Cobro_PlanCobro1]
GO
ALTER TABLE [dbo].[Cobro]  WITH CHECK ADD  CONSTRAINT [FK_Cobro_Residencia] FOREIGN KEY([residencia])
...
GO
ALTER TABLE [dbo].[Incidencia]  WITH CHECK ADD  CONSTRAINT [FK_Incidencia_Usuario] FOREIGN KEY([usuario])
REFERENCES [dbo].[Usuario] ([ID])
GO
ALTER TABLE [dbo].[Incidencia] CHECK CONSTRAINT [FK_Incidencia_Usuario]
GO
ALTER TABLE [dbo].[Reserva]  WITH CHECK ADD  CONSTRAINT [FK_Reserva_EdificioPublico] FOREIGN KEY([edificio])
